  ...
  >
    <div class="shadow sm:overflow-hidden sm:rounded-md">
      <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
        ...
        <div>
          <label for="about" class="block text-sm font-medium text-orange-700"
          ...
          <div class="mt-1">
            <textarea
              ...
              name="about"
              rows="3"
              class="mt-1 block w-full rounded-md border-orange-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm placeholder-orange-400"
        ...
        <div class="flex-grow col-span-6 sm:col-span-3">
          <label for="photo-url" class="block text-sm font-medium text-orange-700"
            >Photo Url</label
          >
          <input
            type="text"
